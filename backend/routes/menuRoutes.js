...
router.post('/item', async (req, res) => {
    ...
    let { menu_id, item_image, item_name, item_desc, item_type, item_price } = ItemDetails;
    try {
        ...
        if (item.statusCode === 200) {
            ...
            const createdItem = await addItem(menu_id, item_image, item_name, item_desc, item_type, item_price);
